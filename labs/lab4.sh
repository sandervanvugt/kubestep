...
if [[ $(kubectl get deploy | awk '/newdb/ { print $4 }') == 0 ]]
then
	echo -e "\033[31m[FAIL]\033[0mSorry, your deployment is still not working. There must be something wrong that I haven't considered. I'm afraid I can't help you anymore." 
	rm /tmp/lab4check2
	exit 6
fi
