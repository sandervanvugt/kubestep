...
then 
	echo -e "\033[32m[OK]\033[0m\t\t Good! Minikube is running"
else 
	echo -e "\033[31m[FAIL]\033[0m\t\t I don't see minikube running. Please use \033[1mgit clone https://github.com/sandervanvugt/kubestep\033[0m and run \033[1m./minikube-docker-setup.sh \033[0m from the course Git repository to start it." && exit 3
fi
