...
if ! [ -z $FINDOUT ]
then 
	echo -e "\033[32m[OK]\033[0m\t\t I have found the YAML file \033[1mnewdb.yaml\033[0m. I'm not smart enough to guarantee that is works though, but we'll find out later"
else 
...
then
	...
	then
		...
		echo
		echo -e "\033[32m[CONGRATS]\033[0m\t\t you have successfully completed this lab, please move on to the next lesson"
		exit
	fi
fi
